...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "remotion-frontend:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkremotion_frontend"] = self["webpackChunkremotion_frontend"] || [];
...
;// ./remotion/compositions/hooks/HookVideo.tsx



const fontFamily = "Roboto";
const getS3AssetUrl = (bucketName, region, path) => {
  return `https://${bucketName}.s3.${region}.amazonaws.com/${path}`;
};
const getAssetUrl = (assetUrls, key, s3Assets, fallbackKey) => {
  if (assetUrls && assetUrls[key]) {
    return assetUrls[key];
  }
  return s3Assets[fallbackKey];
};
const getVideoUrl = (assetUrls, index, s3Assets) => {
...
const VideoComponent = ({ src, style, alt = "Video" }) => {
...
const HookVideo = ({
  ...
  const initialGrowthFrames = 12;
  const fallingDurationFrames = 15;
    ...
    [0.7, 1, 1.08],
    {
      ...
      easing: (t) => {
        if (frame <= initialGrowthFrames) {
          return esm.Easing.bezier(0.8, 0, 0.2, 1)(t);
        }
        return t;
      }
    }
  );
  const yOffset = frame >= startFallingFrame ? (0,esm.interpolate)(
    frame,
    [startFallingFrame, audioFrames],
    [0, 1285],
    {
      extrapolateRight: "clamp",
      easing: esm.Easing.bezier(0.87, 0, 0.13, 1)
    }
  ) : 0;
  const rotation = frame >= startFallingFrame ? (0,esm.interpolate)(
    frame,
    [startFallingFrame, audioFrames],
    [0, 30],
    {
  ...
  const blurAmount = frame >= startFallingFrame ? (0,esm.interpolate)(
    frame,
  ...
  return /* @__PURE__ */ react.createElement("div", { style: containerStyle }, /* @__PURE__ */ react.createElement("div", { style: cardStyle }, /* @__PURE__ */ react.createElement("div", { style: headerStyle }, /* @__PURE__ */ react.createElement("div", { style: profileImageStyle }), /* @__PURE__ */ react.createElement("div", { style: titleContainerStyle }, /* @__PURE__ */ react.createElement("div", { style: channelNameStyle }, /* @__PURE__ */ react.createElement("h1", { style: titleStyle }, channelName), /* @__PURE__ */ react.createElement("img", { src: badgeUrl, style: badgeStyle, alt: "Verified" })), /* @__PURE__ */ react.createElement("div", { style: gifContainerStyle }, [1, 2, 3, 4, 5, 6].map((idx) => /* @__PURE__ */ react.createElement(
    VideoComponent,
    {
      key: idx,
  ...
  ))))), /* @__PURE__ */ react.createElement("h2", { style: postTitleStyle }, hookText), /* @__PURE__ */ react.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginTop: "auto", paddingTop: "10px" } }, /* @__PURE__ */ react.createElement("div", { style: heartContainerStyle }, /* @__PURE__ */ react.createElement("div", { style: iconContainerStyle }, /* @__PURE__ */ react.createElement("div", { style: iconGroupStyle }, /* @__PURE__ */ react.createElement(
    "svg",
    {
      viewBox: "0 0 24 24",
      style: heartIconStyle
    },
    /* @__PURE__ */ react.createElement("path", { d: "M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" })
  ), /* @__PURE__ */ react.createElement("span", { style: counterStyle }, "99+")), /* @__PURE__ */ react.createElement("div", { style: iconGroupStyle }, /* @__PURE__ */ react.createElement("img", { src: bubbleUrl, style: bubbleIconStyle, alt: "Comments" }), /* @__PURE__ */ react.createElement("span", { style: counterStyle }, "99+")))), /* @__PURE__ */ react.createElement("div", { style: shareContainerStyle }, /* @__PURE__ */ react.createElement("div", { style: iconGroupStyle }, /* @__PURE__ */ react.createElement("img", { src: shareUrl, style: shareIconStyle, alt: "Share" }), /* @__PURE__ */ react.createElement("span", { style: shareTextStyle }, "Share"))))), audioUrl && /* @__PURE__ */ react.createElement(esm.Audio, { src: audioUrl }));
};

;// ./remotion/compositions/hooks/FloatingHookVideo.tsx



const FloatingHookVideo_fontFamily = "Roboto";
const FloatingHookVideo_getS3AssetUrl = (bucketName, region, path) => {
  return `https://${bucketName}.s3.${region}.amazonaws.com/${path}`;
};
const FloatingHookVideo_getAssetUrl = (assetUrls, key, s3Assets, fallbackKey) => {
  if (assetUrls && assetUrls[key]) {
    return assetUrls[key];
  }
  return s3Assets[fallbackKey];
};
const FloatingHookVideo_getVideoUrl = (assetUrls, index, s3Assets) => {
  if (assetUrls && assetUrls.videos && assetUrls.videos[`video${index}`]) {
    return assetUrls.videos[`video${index}`];
  }
  return s3Assets.videos[`video${index}`];
};
const FloatingHookVideo_VideoComponent = ({ src, style, alt = "Video" }) => {
  return /* @__PURE__ */ react.createElement(
    esm.OffthreadVideo,
    {
      src,
...
const FloatingHookVideo = ({
  ...
  const { fps, width, height } = (0,esm.useVideoConfig)();
  const s3Assets = react.useMemo(() => ({
    robotoFont: FloatingHookVideo_getS3AssetUrl(bucketName, bucketRegion, "fonts/Roboto-Bold.ttf"),
    verificationBadge: FloatingHookVideo_getS3AssetUrl(bucketName, bucketRegion, "assets/badge.png"),
    bubble: FloatingHookVideo_getS3AssetUrl(bucketName, bucketRegion, "assets/bubble.svg"),
    share: FloatingHookVideo_getS3AssetUrl(bucketName, bucketRegion, "assets/share.svg"),
    videos: {
      video1: FloatingHookVideo_getS3AssetUrl(bucketName, bucketRegion, "assets/videos/11.mp4"),
      video2: FloatingHookVideo_getS3AssetUrl(bucketName, bucketRegion, "assets/videos/22.mp4"),
      video3: FloatingHookVideo_getS3AssetUrl(bucketName, bucketRegion, "assets/videos/33.mp4"),
      video4: FloatingHookVideo_getS3AssetUrl(bucketName, bucketRegion, "assets/videos/44.mp4"),
      video5: FloatingHookVideo_getS3AssetUrl(bucketName, bucketRegion, "assets/videos/55.mp4"),
      video6: FloatingHookVideo_getS3AssetUrl(bucketName, bucketRegion, "assets/videos/66.mp4")
    }
  }), [bucketName, bucketRegion]);
  react.useEffect(() => {
    const customFontFace = new FontFace("Roboto", `url(${s3Assets.robotoFont})`);
  ...
  const videoIndex = getVideoIndex();
  let videoSrc = FloatingHookVideo_getVideoUrl(assetUrls, videoIndex, s3Assets);
  const badgeUrl = FloatingHookVideo_getAssetUrl(assetUrls, "badge", s3Assets, "verificationBadge");
  const bubbleUrl = FloatingHookVideo_getAssetUrl(assetUrls, "bubble", s3Assets, "bubble");
  const shareUrl = FloatingHookVideo_getAssetUrl(assetUrls, "share", s3Assets, "share");
  const initialGrowthFrames = 12;
  const shrinkingDurationFrames = 4;
  const audioFrames = Math.ceil(audioDurationInSeconds * fps);
    ...
    [0.7, 1, 1.05, 0],
    {
      ...
      easing: (t) => {
        if (frame <= initialGrowthFrames) {
          ...
          return esm.Easing.bezier(0.2, 0, 0.8, 1)(t);
        }
        return t;
      }
    }
  ...
  const floatCyclesPerSecond = 1;
  const floatOffset = frame >= initialGrowthFrames && frame < startShrinkingFrame ? floatAmplitude * Math.sin(
    (frame - initialGrowthFrames) * (2 * Math.PI * floatCyclesPerSecond / fps)
  ) : 0;
  const rotationAmplitude = 0.75;
  const rotation = frame >= initialGrowthFrames && frame < startShrinkingFrame ? rotationAmplitude * Math.sin(
    (frame - initialGrowthFrames) * (2 * Math.PI * floatCyclesPerSecond / fps)
  ) : 0;
  const blurAmount = frame >= startShrinkingFrame ? (0,esm.interpolate)(
    frame,
    [startShrinkingFrame, audioFrames],
    [0, 3],
    {
      extrapolateRight: "clamp",
      easing: esm.Easing.bezier(0.2, 0, 0.8, 1)
    }
  ) : 0;
  const containerStyle = {
    display: "flex",
  ...
  const titleStyle = {
    ...
    color: "#1a1a1a",
    margin: 0,
    fontFamily: FloatingHookVideo_fontFamily
  };
  const postTitleStyle = {
    fontSize: "45px",
    color: "#1a1a1a",
  ...
  return /* @__PURE__ */ react.createElement("div", { style: containerStyle }, /* @__PURE__ */ react.createElement("div", { style: cardStyle }, /* @__PURE__ */ react.createElement("div", { style: headerStyle }, /* @__PURE__ */ react.createElement("div", { style: profileImageStyle }), /* @__PURE__ */ react.createElement("div", { style: titleContainerStyle }, /* @__PURE__ */ react.createElement("div", { style: channelNameStyle }, /* @__PURE__ */ react.createElement("h1", { style: titleStyle }, channelName), /* @__PURE__ */ react.createElement("img", { src: badgeUrl, style: badgeStyle, alt: "Verified" })), /* @__PURE__ */ react.createElement("div", { style: gifContainerStyle }, [1, 2, 3, 4, 5, 6].map((idx) => /* @__PURE__ */ react.createElement(
    FloatingHookVideo_VideoComponent,
    {
      key: idx,
      src: FloatingHookVideo_getVideoUrl(assetUrls, idx, s3Assets),
      style: gifStyle,
      alt: `Video ${idx}`
    }
  ))))), /* @__PURE__ */ react.createElement("h2", { style: postTitleStyle }, hookText), /* @__PURE__ */ react.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginTop: "auto", paddingTop: "10px" } }, /* @__PURE__ */ react.createElement("div", { style: heartContainerStyle }, /* @__PURE__ */ react.createElement("div", { style: iconContainerStyle }, /* @__PURE__ */ react.createElement("div", { style: iconGroupStyle }, /* @__PURE__ */ react.createElement(
...
;// ./remotion/compositions/subtitles/SubtitleCard.tsx



const SubtitleCard_getS3AssetUrl = (path) => {
  const bucketName = "reddit-clipper-assets";
  return `https://${bucketName}.s3.us-east-1.amazonaws.com/${path}`;
};
const s3Assets = {
  jelleeFont: SubtitleCard_getS3AssetUrl("fonts/Jellee-Roman.ttf"),
  robotoFont: SubtitleCard_getS3AssetUrl("fonts/Roboto-Bold.ttf")
};
const colorMap = {
  white: "#ffffff",
  yellow: "#ffff00",
...
const SubtitleCard = ({
  ...
  const scale = (0,esm.interpolate)(
    ...
    [0.95, 1.05, 1],
    {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp",
      easing: esm.Easing.bezier(0.22, 1, 0.36, 1)
    }
  );
  ...
  } }, text), /* @__PURE__ */ react.createElement("h1", { style: {
    fontFamily: font,
    fontSize: `${subtitle_size}px`,
    fontWeight: 700,
    color: textColor,
...
;// ./remotion/compositions/subtitles/SubtitleComposition.tsx
...
const SubtitleComposition = ({
  ...
  if (wordTimings.length > 0) {
    return /* @__PURE__ */ react.createElement(esm.AbsoluteFill, { style: {
      background: "transparent"
    } }, wordTimings.map((word, index) => /* @__PURE__ */ react.createElement(
      SubtitleCard,
      {
        key: index,
        text: word.text,
...
;// ./remotion/compositions/BackgroundVideo.tsx



const BackgroundVideo = ({ backgroundVideoPath, volume = 0, totalDurationInFrames }) => {
  const videoArray = Array.isArray(backgroundVideoPath) ? backgroundVideoPath : [backgroundVideoPath];
  const videos = videoArray.map((item) => {
    if (typeof item === "string") {
      return { path: item };
    } else if (typeof item === "object" && item !== null && "path" in item && "durationInFrames" in item) {
      return {
        path: item.path,
        // Type assertion to imported VideoInfo
  ...
  return /* @__PURE__ */ react.createElement("div", { style: {
    ...
    height: "100%",
    overflow: "hidden"
  } }, /* @__PURE__ */ react.createElement(esm.Series, null, videos.map((video, index) => /* @__PURE__ */ react.createElement(
    esm.Series.Sequence,
    {
      key: `${video.path}-${index}`,
      durationInFrames: video.durationInFrames || totalDurationInFrames || 300
    },
...
;// ./remotion/assets/music/music.mp3
const music_namespaceObject = __webpack_require__.p + "c722b531e3c050fb.mp3";
...
const MainComposition = ({
  ...
  ), has_background_music && /* @__PURE__ */ react.createElement(
    esm.Audio,
    {
  ...
  ), /* @__PURE__ */ react.createElement(esm.Series, null, /* @__PURE__ */ react.createElement(esm.Series.Sequence, { durationInFrames: hookDurationInFrames }, /* @__PURE__ */ react.createElement(
    HookVideoComponent,
    {
      channelName,
      channelImage,
  ...
  )), /* @__PURE__ */ react.createElement(esm.Series.Sequence, { durationInFrames: scriptDurationInFrames }, /* @__PURE__ */ react.createElement(
    SubtitleComposition,
    {
      text: subtitleText,
      wordTimings,
  ...
  ), /* @__PURE__ */ react.createElement(esm.Audio, { src: scriptAudioUrl }))));
};
...
const schema = objectType({
  ...
  channelImage: stringType(),
  hookText: stringType(),
  audioUrl: stringType(),
  audioDurationInSeconds: numberType(),
  hook_animation_type: enumType(["fall", "float"]).optional(),
  subtitleText: stringType(),
  scriptAudioUrl: stringType(),
  scriptAudioDurationInSeconds: numberType(),
  wordTimings: arrayType(objectType({
    text: stringType(),
    startFrame: numberType(),
    endFrame: numberType(),
    color: stringType().optional()
  })),
  totalDurationInFrames: numberType(),
  backgroundVideoPath: unionType([
    stringType(),
    arrayType(stringType()),
    arrayType(objectType({
      path: stringType(),
      durationInFrames: numberType(),
      durationInSeconds: numberType().optional()
    }))
  ]),
  assetUrls: objectType({
    badge: stringType().optional(),
    bubble: stringType().optional(),
    share: stringType().optional()
  }).optional(),
  bucketName: stringType().optional(),
  bucketRegion: stringType().optional()
});
const defaultProps = {
  channelName: "Default Channel",
  channelImage: "",
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    __webpack_require__.e(/* import() */ 86).then(__webpack_require__.bind(__webpack_require__, 4086)).then(({ StudioInternals }) => {
